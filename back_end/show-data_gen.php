...
$req="
   SELECT ENTREPRISE.ID_ENTREPRISE, NOM_ENTREPRISE,ADRESSE_ENTREPRISE,
      VILLE_ENTREPRISE,REFUS_ANNEE_SIO1,TEL_ENTREPRISE,EMAIL_ENTREPRISE,0 AS NB_ET 
      FROM entreprise 
      WHERE ID_ENTREPRISE 
            NOT IN (
   ...
   SELECT ENTREPRISE.ID_ENTREPRISE,NOM_ENTREPRISE,ADRESSE_ENTREPRISE,VILLE_ENTREPRISE
      ,REFUS_ANNEE_SIO1, TEL_ENTREPRISE,EMAIL_ENTREPRISE,COUNT(ID_DEMARCHE) AS NB_ET 
...
$stmt = $db->prepare("SELECT * FROM entreprise WHERE REFUS_ANNEE_SIO1=0 ");
$stmt->execute(); 
...
$stmt = $db->prepare("SELECT * FROM entreprise WHERE REFUS_ANNEE_SIO1=1 ");
$stmt->execute(); 
