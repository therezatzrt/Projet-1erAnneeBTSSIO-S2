<!--   NR le 24/12/2020
//  Ce fichier comporte les affichages de la page de connexion pour un utilisateur quand il a choisi 
...
<?php 
    $title = "Connexion";
    include '../includes/header_inviter.php';    
                ...
                <div class="content-wrapper d-flex align-items-center auth px-0">
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5"> <!-- boostrap -->
