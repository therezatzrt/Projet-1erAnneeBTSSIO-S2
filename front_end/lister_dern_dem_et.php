                 ...
                 <table class="table">
                        <thead>
                            <tr>
                                                ...
                                                <?php if($countStageAT==0){
                                                    echo'

                                                <th scope="col">Effectuer démarche</th>
                                 ...
                                 foreach( $demarches as $row ) {  
                                    ...
                                    <tr>
                                        ...
                                        if($countStageAT==0){
                                            echo'
                                        <td>
                                        <a href="creer_demarche.php?id='.$row['ID_ENTREPRISE'].'" <span class="badge badge-success">Effectuer une démarche</span></a>
                                        </td>
                                    </tr>
                                       ';}
                                       ;} ?>
